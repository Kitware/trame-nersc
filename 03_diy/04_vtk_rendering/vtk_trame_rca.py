...
from trame.widgets import vuetify3 as v3, rca
...
def setup_vtk():
    ...
    return renderWindow, renderer, surface


class VtkApp(TrameApp):
    def __init__(self, server=None):
        super().__init__(server)
        self.render_window, self.renderer, self.source = setup_vtk()
        self._build_ui()
    ...
    @controller.set("view_reset_camera")
            ...
            with self.ui.content:
                with v3.VContainer(fluid=True, classes="ma-0 pa-0 h-100"):
                    with rca.RemoteControlledArea(
                        ...
                        self.ctrl.view_update = self.view_handler.update
