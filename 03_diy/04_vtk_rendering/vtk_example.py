...
def main():
    ...
    sliderRepMinimumU.GetPoint1Coordinate().SetValue(0.1, 0.1)
    sliderRepMinimumU.GetPoint2Coordinate().SetCoordinateSystemToNormalizedDisplay()
    sliderRepMinimumU.GetPoint2Coordinate().SetValue(0.9, 0.1)
    ...
    sliderWidgetMinimumU.AddObserver(
        "InteractionEvent", SliderCallbackMinimumU(surface)
    )
    ...
    sliderRepMaximumU.GetPoint1Coordinate().SetValue(0.1, 0.9)
    sliderRepMaximumU.GetPoint2Coordinate().SetCoordinateSystemToNormalizedDisplay()
    sliderRepMaximumU.GetPoint2Coordinate().SetValue(0.9, 0.9)
    ...
    sliderWidgetMaximumU.AddObserver(
        "InteractionEvent", SliderCallbackMaximumU(surface)
    )
    ...
    sliderRepMinimumV.GetPoint1Coordinate().SetValue(0.1, 0.1)
    sliderRepMinimumV.GetPoint2Coordinate().SetCoordinateSystemToNormalizedDisplay()
    sliderRepMinimumV.GetPoint2Coordinate().SetValue(0.1, 0.9)
    ...
    sliderWidgetMinimumV.AddObserver(
        vtkCommand.InteractionEvent, SliderCallbackMinimumV(surface)
    )

    sliderRepMaximumV = vtkSliderRepresentation2D()

    sliderRepMaximumV.SetMinimumValue(0.05)
    sliderRepMaximumV.SetMaximumValue(vtkMath.Pi() - 0.05)
    ...
    sliderRepMaximumV.GetPoint1Coordinate().SetValue(0.9, 0.1)
    sliderRepMaximumV.GetPoint2Coordinate().SetCoordinateSystemToNormalizedDisplay()
    sliderRepMaximumV.GetPoint2Coordinate().SetValue(0.9, 0.9)
    ...
    sliderWidgetMaximumV.AddObserver(
        vtkCommand.InteractionEvent, SliderCallbackMaximumV(surface)
    )
...
class SliderCallbackMaximumU:
    ...
    def __call__(self, caller, ev):
        sliderWidget = caller
        value = sliderWidget.GetRepresentation().GetValue()
        if value < self.kuen.GetMinimumU() + 0.01:
            value = self.kuen.GetMinimumU() + 0.01
            sliderWidget.GetRepresentation().SetValue(value)
...
class SliderCallbackMaximumV:
    ...
    def __call__(self, caller, ev):
        sliderWidget = caller
        value = sliderWidget.GetRepresentation().GetValue()
        if value < self.kuen.GetMinimumV() + 0.01:
            value = self.kuen.GetMinimumV() + 0.01
            sliderWidget.GetRepresentation().SetValue(value)
